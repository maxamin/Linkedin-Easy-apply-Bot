...
class LinkedinEasyApply:
    def __init__(self, parameters, driver):
        ...
        self.positions = [""]#["Specialist","Engineer","technician","Expert","Consultant","junior","senior"," ","     ","       ","    ","   ","  "," ","Freelancer","infrastructure","sap","Developer","Android","IOS","Devops","Devsecops","tester","Web application","Desktop application","Mobile application","Red team","junior","cyber security","soc analyst","security","penetration tester","infosec","securité informatique","security engineer","System administrator","Network administrator","information technology","technical writer","solutions security"]
        self.locations =["Tunisia","Brazil","Colombia","Argentina","Peru","Venezuela","Chile","Ecuador","Bolivia","Paraguay","Uruguay","Indonesia","Japan","Philippines","United Kingdom","Madagascar","Australia","Taiwan","Sri Lanka","Haiti","Cuba","Dominican Republic","Papua New Guinea","Singapore","Ireland","New Zealand","Jamaica","Bahrain","Trinidad And Tobago","Timor Leste","Mauritius","Cyprus","Fiji","Comoros","Solomon Islands","Cape Verde","Maldives","Brunei","Malta","Bahamas","Iceland","Vanuatu","Barbados","Sao Tome And Principe","Samoa","Saint Lucia","Kiribati","Micronesia","Grenada","Saint Vincent And the Grenadines","Tonga","Antigua And Barbuda","Seychelles","Dominica","Marshall Islands","Saint Kitts And Nevis","Palau","Tuvalu","Nauru","Guyana","Suriname","FrenchGuiana","FalklandIslands","eastern europe","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Worldwide","Switzerland","malta","Sweden","USA","Korea","Canada","italy","germany","Neitherlands","Belgium","Sweden","poland","Romania","Australia","Portugal","Cyprus","Croatia","Bulgaria","Czech","Ireland","Slovakia","Slovakia","Malta","Luxembourg","Spain","Slovenia","Lithuania","Latvia","Greece","Hungary","united kingdom","Netherlands","Singapore","Finland","Denmark","Norway","Qatar","EUR","UAE","Austria","germany","European union","austria","japan","France","Norway","Switzerland","Ireland","Hong Kong","Iceland","Germany","Sweden","Australia","Netherlands","Denmark","Singapore","Finland","United Kingdom","Belgium","New Zealand","Canada","United States","Austria","Japan","Liechtenstein","Slovenia","South Korea","Luxembourg","Spain","France","Malta","Italy","Estonia","United Arab Emirates","Greece","Cyprus","Lithuania","Poland","Andorra","Latvia","Portugal","Slovakia","Saudi Arabia","Hungary","Bahrain","Chile","Croatia","Qatar","Argentina","Montenegro","Romania","Palau","Kazakhstan","Russia","Belarus","Turkey","Uruguay","Bulgaria","Panama","Bahamas","Barbados","Oman","Georgia","Malaysia","Costa Rica","Serbia","Kuwait","Mauritius"]
